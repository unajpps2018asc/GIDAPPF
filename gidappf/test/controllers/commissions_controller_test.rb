...
class CommissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commission" do
    assert_difference('Commission.count') do
      post commissions_url, params: { commission: { description: @commission.description, end_date: @commission.end_date, name: @commission.name, start_date: @commission.start_date } }
    end
  ...
  test "should update commission" do
    patch commission_url(@commission), params: { commission: { description: @commission.description, end_date: @commission.end_date, name: @commission.name, start_date: @commission.start_date } }
